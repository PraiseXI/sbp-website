...
const HeroSection = () => {
  return (
    <div className=" relative flex flex-col justify-center items-center text-center bg-transparent px-4 sm:px-6 lg:px-8" style={{ height: '70vh' }}>
      <motion.div
        ...
        className="z-10"
      >
        <h1 className="text-white text-5x sm:text-5xl md:text-6xl lg:text-8xl font-bold mb-4">
